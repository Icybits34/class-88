...
this.props.navigation.navigate("Feed.js")
  }
  else{
    Alert.alert("error","all fields are required",[{text:"ok",onPress:()=>console.log("okPress")}],
    {cancelable:false})
  }
}
  render() {
          ...
          <View style={styles.fieldsContainer}>
            ...
            <ScrollView>
              ...
              <TextInput
                ...
                placeholderTextColor="white"
              />
              <View style={styles.sumbitButton}>
                <Button onPress={()=>this.addStory()}
                title="Sumbit" color="#841584"></Button>
              </View>
            </ScrollView>
          </View>
